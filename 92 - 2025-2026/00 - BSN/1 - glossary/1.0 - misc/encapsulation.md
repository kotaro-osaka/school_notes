...
> [[92 - 2025-2026/00 - BSN/1 - glossary/1.1 - protocols/tcp|TCP]]
...
- `Protocol`: Specifies protocol used for encapsulating payload ([[92 - 2025-2026/00 - BSN/1 - glossary/1.1 - protocols/tcp|TCP]] / [[92 - 2025-2026/00 - BSN/1 - glossary/1.1 - protocols/udp|UDP]] / [[92 - 2025-2026/00 - BSN/1 - glossary/1.1 - protocols/icmp|ICMP]])
- `Checksum`: Calculated by algorithm before sending and on receipt, if identical, no alteration during transport
