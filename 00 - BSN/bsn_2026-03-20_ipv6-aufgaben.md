...
| 134 | Router Advertisement (RA)  | Router senden diese Nachricht alle `200` Sekunden oder als direkte Antwort auf eine *RS*.<br>Enthält `Netzpräfix`, `MTU` des Links, `Gültigkeitsdauer` der Adressen, `Flags`, die dem Host |
